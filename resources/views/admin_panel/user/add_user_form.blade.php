...
@section("main_content")
    ...
    <div class="container mt-xl-30 mt-sm-30 mt-15">
        ...
        <div class="hk-pg-header align-items-top">
            <h2 class="hk-pg-title font-weight-700 mb-10 text-muted"><i class="fa fa-plus"> Add New User</i>
            </h2>
        </div>
        <!-- /Title -->
                            ...
                            <form action="{{route('user.store')}}" method="post" novalidate
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="user_username" placeholder="Enter username"
                                               class="form-control" value="{{old('user_username')}}" required>
                                    </div>
                                    <p class="text-danger" id="user_username_error_message"></p>
                                    @if($errors->has('user_username'))
                                        <p class="text-danger">{{ $errors->first('user_username') }}</p>
                                    @endif
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="user_password" placeholder="Enter "
                                               class="form-control" value="{{old('user_password')}}" required>
                                    </div>
                                    <p class="text-danger" id="user_password_error_message"></p>
